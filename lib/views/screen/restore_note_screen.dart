...
class RestoreNoteScreen extends StatefulWidget {
  ...
  final String title;
  final String note ;
  const RestoreNoteScreen({Key? key,required this.id, required this.date, required this.title, required this.note}) : super(key: key);
                ...
                GetBuilder<FetchDataController>(
                    builder: (_fetchDataController) {
                      return GestureDetector(onTap: ()async{
                        final response = await _fetchDataController.deleteTrashData(id: widget.id!,);
                        if(response == true){
