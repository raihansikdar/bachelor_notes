...
class ShoppingRecycleBinScreen extends StatefulWidget {
  ...
  @override
  State<ShoppingRecycleBinScreen> createState() =>
      _ShoppingRecycleBinScreenState();
}
        ...
        child: Column(
          children: [
                ...
                Get.find<FetchShoppingDataController>()
                    ...
                    : showDialog(
                        ...
                        builder: (context) {
                          return AlertDialog(
                            backgroundColor:
                                const Color.fromARGB(255, 56, 39, 39),
                            ...
                            content: const Text(
                              "Are you sure you want to delete all the notes from Recycle bin?",
                              style: TextStyle(
                                  fontSize: 14.0,
            ...
            /*const ScrollLoopAutoScroll(
              ...
              child: Text(
                "All notes will be deleted permanently after 30 days.",
                style: TextStyle(
                    fontSize: 13.0,
                    fontWeight: FontWeight.w400,
                    letterSpacing: 0.5,
            ...
            GetBuilder<FetchShoppingDataController>(
              ...
              } else if (_fetchShoppingDataController
                  .shoppingNoteRecycleBinList.isEmpty) {
                return Center(
                  child: Column(
                    children: [
                      const SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return GestureDetector(
                        onTap: () {
                          Get.to(
                            () => RestoreShoppingNoteScreen(
                              id: _fetchShoppingDataController
                                  .shoppingNoteRecycleBinList[index].id!,
                              title: _fetchShoppingDataController
                                  .shoppingNoteRecycleBinList[index].title!,
                              date: _fetchShoppingDataController
                                  .shoppingNoteRecycleBinList[index].date!,
                              capital: _fetchShoppingDataController
                                  .shoppingNoteRecycleBinList[index].capital!,
                              remain: _fetchShoppingDataController
                                  .shoppingNoteRecycleBinList[index].remain!,
                              itemTitles: _fetchShoppingDataController
                                  .shoppingNoteRecycleBinList[index]
                                  .itemTitles!,
                              prices: _fetchShoppingDataController
                                  .shoppingNoteRecycleBinList[index].prices!,
                              totalCost: _fetchShoppingDataController
                                  .shoppingNoteRecycleBinList[index].totalCost!,
                            ),
                          );
                        },
                        child: ShoppingRecycleBinNoteDataWidget(
                          shoppingRecycleBinListData:
                              _fetchShoppingDataController
                                  .shoppingNoteRecycleBinList[index],
                        ));
                  },
                ),
