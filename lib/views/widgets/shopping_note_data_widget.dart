...
class ShoppingNoteDataWidget extends StatelessWidget {
  ...
  const ShoppingNoteDataWidget({
    super.key, required this.shoppingListData,
  });
              ...
              child: Column(
                ...
                children: [
                  ...
                  ListView.builder(
                    shrinkWrap: true,
                    primary: false,
                    itemCount: shoppingListData.itemTitles?.length ?? 0,
                    itemBuilder: (context,innerIndex){
                      final items = shoppingListData.itemTitles;
                      final price = shoppingListData.prices;
                      return Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          SizedBox(
                      ...
                      child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              const Spacer(),
                              Text("${shoppingListData.totalCost?.toStringAsFixed(2)} tk",
                                style: TextStyle(
                                  fontSize: 16.0,
                                  fontWeight: FontWeight.w700,
                                  color: AppColors.yellowColor,
